...
public class ClothController {
	...
	@PostMapping("/cloth/replyInsert")
	public String replyInsert(PjReply vo) {
		return rservice.replyInsert(vo);
	}
	
	
	@PostMapping("/cloth/replyDelete")
	public String replyDelete(int rno) {
		System.out.println("rno:"+rno);
		return rservice.replyDelete(rno);
	}
	@PostMapping("/cloth/replyUpdate")
	public String replyDelete(PjReply vo) {
		
		return rservice.replyUpdate(vo);
	}
}
